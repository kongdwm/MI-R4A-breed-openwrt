...
sed -i 's/OpenWrt /2024.7.31 $(TZ=UTC-8 date "+%Y.%m.%d") @ 空的名字 /g' package/lean/default-settings/files/zzz-default-settings
...
sed -i 's/ssid=OpenWrt/ssid=MIWIFI_2024/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
